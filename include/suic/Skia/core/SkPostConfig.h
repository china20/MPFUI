...
#    define SK_ENABLE_INST_COUNT 0//!defined(SKIA_DLL)
#  else
...
#  if defined(_MSC_VER)
#    define SK_ATOMICS_PLATFORM_H "../../skia/ports/SkAtomics_win.h"
...
#  if defined(SK_BUILD_FOR_WIN)
#    define SK_MUTEX_PLATFORM_H "../../skia/ports/SkMutex_win.h"
#  else
