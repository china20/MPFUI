...
#endif
    virtual int onDecode(SkStream* stream, SkBitmap* bm, Mode) SK_OVERRIDE;
...
int SkPNGImageDecoder::onDecode(SkStream* sk_stream, SkBitmap* decodedBitmap,
                                 Mode mode) {
    png_structp png_ptr;
    png_infop info_ptr;
