...
SkShader::GradientType SkShader::asAGradient(SkShader::GradientInfo* info) const {
...
SkShader::GradientType SkColorShader::asAGradient(SkShader::GradientInfo* info) const {
    if (info) {
