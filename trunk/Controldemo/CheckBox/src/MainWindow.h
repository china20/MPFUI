...
// </Summary>
//
class BindingData : public suic::ICommand, public suic::NotifyPropChanged
{
public:

    BeginMember(BindingData, suic::NotifyPropChanged)
        MemberString(ButtonName)
    EndMember()

    RTTIOfClass(BindingData)

    BindingData()
    {
        _btnName = "Bind Button";
    }
...
public:
    ...
    void OnPopupWindow(suic::Element* sender, suic::RoutedEventArg* e);
    void OnCheckedChanged(suic::Element* sender, suic::RoutedEventArg* e);
