...
public:
    ...
    static bool GoToStateCommon(FrameworkElement* control, FrameworkElement* stateGroupsRoot, String stateName, bool useTransitions)
    { 
        if (stateName.Empty())
        { 
            throw ArgumentNullException("stateName"); 
        }
        ...
        ITList<VisualStateGroup> groups = VisualStateManager.GetVisualStateGroupsInternal(stateGroupsRoot); 
        if (groups == null) 
        {
            return false; 
        }
    ...
    static bool GoToState(FrameworkElement* control, String stateName, bool useTransitions)
    { 
        if (!control)
        { 
            throw ArgumentNullException("control"); 
        }

        FrameworkElement* stateGroupsRoot = control->GetStateGroupsRoot();

        return GoToStateCommon(control, stateGroupsRoot, stateName, useTransitions);
    } 

    static bool GoToElementState(FrameworkElement* stateGroupsRoot, string stateName, bool useTransitions) 
    {
        if (!stateGroupsRoot) 
        { 
            throw ArgumentNullException("stateGroupsRoot");
        } 

        return GoToStateCommon(NULL, stateGroupsRoot, stateName, useTransitions);
    }

    static DpProperty* CustomVisualStateManagerProperty;

    static VisualStateManager* GetCustomVisualStateManager(FrameworkElement* obj) 
    {
        if (!obj) 
        { 
        ...
        return DynamicCast<VisualStateManager>(obj->GetValue(VisualStateManager::CustomVisualStateManagerProperty));
    }

    static void SetCustomVisualStateManager(FrameworkElement* obj, VisualStateManager* value)
    { 
        if (!obj) 
        {
            throw ArgumentNullException("obj"); 
    ...
    static DpProperty* VisualStateGroupsProperty;

private:
    
    static TCollection<VisualStateGroup> GetVisualStateGroupsInternal(FrameworkElement* obj)
        { 
            if (!obj) 
            {
                throw ArgumentNullException("obj"); 
            ...
            { 
                return obj.GetValue(VisualStateManager.VisualStateGroupsProperty) as TCollection<VisualStateGroup>;
            } 
        ...
        public static ITList GetVisualStateGroups(FrameworkElement obj) 
        { 
            if (obj == null)
            { 
                throw ArgumentNullException("obj");
            ...
            return obj.GetValue(VisualStateManager.VisualStateGroupsProperty) as ITList; 
        }
        ...
        internal static bool TryGetState(ITList<VisualStateGroup> groups, string stateName, out VisualStateGroup group, out VisualState state)
        {
        ...
        { 
            ...
            if (state == null)
            {
                throw ArgumentNullException("state");
            } 
        ...
        { 
            if (stateGroup == null)
            { 
                throw ArgumentNullException("stateGroup"); 
            }
 
            if (newState == null)
            {
                throw ArgumentNullException("newState");
            } 
        ...
        { 
            ...
            if (result == null)
            { 
                Float? targetDouble = GetTargetDouble(timeline, isEntering); 
        ...
        internal static VisualTransition GetTransition(FrameworkElement element, VisualStateGroup group, VisualState from, VisualState to)
        {
            ...
            if (group == null) 
            {
                throw ArgumentNullException("group");
            }
 
            if (to == null)
            { 
                throw ArgumentNullException("to"); 
            }
            ...
            ITList<VisualTransition> transitions = (ITList<VisualTransition>)group.Transitions;
            if (transitions != null) 
            { 
        ...
        private static Float? GetTargetDouble(Timeline timeline, bool isEntering)
        { 
        ...
        private static Dictionary<TimelineDataToken, Timeline> FlattenTimelines(TCollection<Storyboard> storyboards) 
        {
            Dictionary<TimelineDataToken, Timeline> result = new Dictionary<TimelineDataToken, Timeline>(); 
