...
{									// MUST be in exact 1-to-1 with rgKeyword
	...
	i_pmmetafile,
	i_pn,
	i_pnaiueo,  // GuyBark JupiterJ: added this
	i_pnaiueod, // GuyBark JupiterJ: added this
	i_pndec,
	i_pnindent,
	i_pniroha,  // GuyBark JupiterJ: added this
	i_pnirohad, // GuyBark JupiterJ: added this
	i_pnlcltr,
	i_pnlcrm,
	i_pnlvlblt,
	i_pnlvlbody,
