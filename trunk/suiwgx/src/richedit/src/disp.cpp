...
{
    BOOL bVertBar;
    return RecalcView(rcView, bVertBar);
}

BOOL CDisplay::RecalcViewEx()
{
    BOOL bVertBar = FALSE;
    RECT rcView;
    
    GetViewRect(rcView, NULL);
    RecalcView(rcView, bVertBar);
    return bVertBar;
}

VOID CDisplay::UpdateCaretEx()
{
    if (_fUpdateCaret)
    {
        // 取得选择区域
 ...
 */
BOOL CDisplay::RecalcView (
	const RECT &rcView, BOOL& bVertBar)
{
