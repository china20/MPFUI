...
LONG CW32System::ImmGetCompositionStringA ( HIMC h, DWORD flag, LPVOID lpBuff, DWORD buffLen)
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetCompositionStringA(h, flag, lpBuff, buffLen);
}
...
BOOL CW32System::ImmSetCompositionFontA ( HIMC h, LPLOGFONTA lpFont)
{
    #pragma message ("Review : Incomplete")
    return ::ImmSetCompositionFontA(h, lpFont);
}

BOOL CW32System::ImmSetCompositionWindow ( HIMC h, LPCOMPOSITIONFORM lpComp)
{
    #pragma message ("Review : Incomplete")
    return ::ImmSetCompositionWindow(h, lpComp);
}

BOOL CW32System::ImmReleaseContext ( HWND hwnd, HIMC h)
{
    #pragma message ("Review : Incomplete")
    return ::ImmReleaseContext(hwnd, h);
}

DWORD CW32System::ImmGetProperty ( HKL h, DWORD flag)
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetProperty(h, flag);
}

BOOL CW32System::ImmGetCandidateWindow ( HIMC h, DWORD flag, LPCANDIDATEFORM lpCand)
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetCandidateWindow(h, flag, lpCand);
}

BOOL CW32System::ImmSetCandidateWindow ( HIMC h, LPCANDIDATEFORM lpCand)
{
    #pragma message ("Review : Incomplete")
    return ::ImmSetCandidateWindow(h, lpCand);
}

BOOL CW32System::ImmNotifyIME ( HIMC h, DWORD f1, DWORD f2, DWORD f3 )
{
    #pragma message ("Review : Incomplete")
    return ::ImmNotifyIME(h, f1, f2, f3);
}

HIMC CW32System::ImmAssociateContext ( HWND hwnd, HIMC h )
{
    #pragma message ("Review : Incomplete")
    return ::ImmAssociateContext(hwnd, h);
}

UINT CW32System::ImmGetVirtualKey ( HWND hwnd )
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetVirtualKey(hwnd);
}

HIMC CW32System::ImmEscape ( HKL hk, HIMC h, UINT flag, LPVOID lpBuff)
{
    #pragma message ("Review : Incomplete")
    return (HIMC)::ImmEscape(hk, h, flag, lpBuff);
}

LONG CW32System::ImmGetOpenStatus ( HIMC h )
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetOpenStatus(h);
}

BOOL CW32System::ImmGetConversionStatus ( HIMC h, LPDWORD lpFlag1, LPDWORD lpFlag2 )
{
    #pragma message ("Review : Incomplete")
    return ::ImmGetConversionStatus(h, lpFlag1, lpFlag2);
}
