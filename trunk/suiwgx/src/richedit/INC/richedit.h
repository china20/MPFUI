...
// GuyBark: Allow RichEdit to get a header comment if 
// neccesary. This is sent FROM RichEdit TO its parent.
#define WM_PWORD_GETHEADERCOMMENT     (WM_USER + 230)
#endif // PWD_REHEADERCOMMENT

// Insert Graphic
#define EM_INSERTGRAPHIC			(WM_USER + 259)

// wparam values for EM_INSERTGRAPHIC
#define IG_TYPE_DIB				1
...
// word break codes are not defined on WinCE
#ifdef UNDER_CE
...
#define	PFN_KATAKANAAIUEOD 7   // tomListNumberAsKatakanaAIUEOdbl, GuyBark JupiterJ: Added this.
#define	PFN_KATAKANAIROHAD 8   // tomListNumberAsKatakanaIRAHOdbl, GuyBark JupiterJ: Added this.
